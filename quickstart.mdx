---
title: 'Quickstart'
description: 'Start using Health Pro in under 5 minutes using this documentation!'
---

<img
  className="block dark:hidden rounded-md"
  src="https://res.cloudinary.com/djdh5ccgk/image/upload/v1713638471/Light_hdidhl.png"
/>
<img
  className="hidden dark:block rounded-md"
  src="https://res.cloudinary.com/djdh5ccgk/image/upload/v1713638469/Dark_dupqer.png"
/>
